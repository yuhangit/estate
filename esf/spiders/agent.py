...
class AgentSpider(scrapy.Spider):
    ...
    total_urls = []
    ## lianjia
    # lianjia_urls = ['https://sh.lianjia.com/jingjiren/pg%i/' %i for i in range(1, 101)]
    # total_urls.extend(lianjia_urls)

    # anjuke
    # total_urls.append('https://shanghai.anjuke.com/tycoon/')

    #Q fang
    # total_urls.append("http://shanghai.qfang.com/tycoon/o0-n1")

    # centanet
    centanet_urls = ["http://sh.centanet.com/jingjiren/g%i/" %i for i in range(1,302)]
    total_urls.extend(centanet_urls)

    start_urls = total_urls

    allowed_domains = ["lianjia.com","anjuke.com","qfang.com","centanet.com"]
    rules = (
    ...
    def parse_item(self, response):
        ...
        if response.url.find("sh.lianjia.com") >= 0:
    ...
    def parse_lianjia(self, response):
        ...
        for li in ul:
            ...
            l.add_xpath("district",'.//div[@class="main-plate"]//a[1]/text()')
            l.add_xpath("subdistrict",'.//div[@class="main-plate"]//a[2]/text()')
    ...
    def parse_anjuke(self,response):
        ...
        for div in divs:
            ...
            l.add_xpath("telephone", '//div[@class="jjr-itemmod"]//div[@class="jjr-side"]/text()'
                        ,MapCompose(lambda x: int(x)),re = r"\d+")
    ...
    def parse_centanet(self, response):
        ...
        for li in ul:
            ...
            l.add_xpath("name", './/p[@class="phone"]/b/@zvalue',
                        re=r"cnName:'(\w+)'")
            l.add_xpath("district",'./li//h2//@title')
